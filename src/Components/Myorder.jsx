      ...
      <Fragment>
        <div className="wrap ATM">
          ...
          <div className="card p-3 mb-4">
            <p className="name">Muhamad Khafidh fuadi</p>
            <p className="saldo">Rp. 7.000.000,00-</p>
            <p className="card-number mb-0">00129126792</p>
          </div>
          <div className="calculate p-3">
            {this.state.list
              ? this.state.list.map((item, i) => (
                  <div
                    key={i}
                    className="items d-flex justify-content-between align-items-center mb-3"
                  >
            ...
            <div className="items d-flex justify-content-between align-items-center mb-3">
              ...
              <p className="mb-0 text">Jonggol</p>
              <p className="mb-0 text">Free ongkir</p>
            </div>
          </div>
